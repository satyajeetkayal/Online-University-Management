				...
				<div class="container">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="forget.aspx">֎ Forget</a></li>
						</ul>
					</nav>
					</div>
				</div>
...
<body>
	...
	<div id="login">
		...
		<h1><strong>Forget </strong>Password!</h1>
		...
		<form action="javascript:void(0);" method="get">
			...
			<fieldset>
                ...
                <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
                    ShowMessageBox="True" />
				<p>
                    <asp:TextBox ID="TextBox2"  required value="Username" 
                        onBlur="if(this.value=='')this.value='Username'" 
                        onFocus="if(this.value=='Username')this.value='' " runat="server" 
                        ontextchanged="TextBox2_TextChanged" AutoPostBack="True" 
                        CausesValidation="True"></asp:TextBox>
                    <asp:Label ID="Label2" CssClass="select" runat="server" Text="Label" 
                        Visible="False"></asp:Label>
                        
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ErrorMessage="UserName Formate (a-z|A-Z &amp; 0-9) Length 4-15" 
                        ControlToValidate="TextBox2" ValidationExpression="[a-zA-Z0-9]{4,15}$">*</asp:RegularExpressionValidator>
                        </p>
				...
				<p>
                    ...
                    <p><asp:TextBox ID="TextBox1" required value="Answer" 
                            onBlur="if(this.value=='')this.value='Answer'" 
                            onFocus="if(this.value=='Answer')this.value='' " runat="server" 
                            CausesValidation="True"></asp:TextBox>
               
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="Required Answer" ControlToValidate="TextBox1">*</asp:RequiredFieldValidator>
              </p>
				...
				<p>
                    <asp:Button ID="Button1"  value="Submit"   Text="Show" runat="server" 
                  ...
                  <p>
                      Password:-<asp:Label ID="Label3" CssClass="select" runat="server" Text="Label"></asp:Label>
