				...
				<div class="container">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="printpage.aspx">֍ Print</a></li>
						</ul>
					</nav>
					</div>
				</div>
...
<p>
	...
	<div id="login">
		...
		<h1><strong>Application Form </strong>Print!</h1>
			...
			<fieldset>
				...
				<p>
                    ...
                    <p>
                        ...
                        <p>
                            <asp:TextBox ID="TextBox5" required value="Date Of Birth" 
                                onBlur="if(this.value=='')this.value='Date Of Birth'" 
                                onFocus="if(this.value=='Date Of Birth')this.value='' " runat="server" 
                                Enabled="False"/>
                            <asp:TextBox ID="TextBox6" required value="Gender" 
                                onBlur="if(this.value=='')this.value='Gender'" 
                                onFocus="if(this.value=='Gender')this.value='' " runat="server" Enabled="False"></asp:TextBox></p>
                            
                            <p>
                                <asp:TextBox ID="TextBox7" required value="Nationality" 
                                    onBlur="if(this.value=='')this.value='Nationality'" 
                                    onFocus="if(this.value=='Nationality')this.value='' " runat="server" 
                                    Enabled="False"/>
                                <asp:TextBox ID="TextBox8" required value="Department" 
                                    onBlur="if(this.value=='')this.value='Department'" 
                                    onFocus="if(this.value=='Department')this.value='' " runat="server" 
                                    Enabled="False"></asp:TextBox></p>
                                
                                  <p>
                                        <asp:TextBox ID="TextBox11" required value="School" 
                                            onBlur="if(this.value=='')this.value='School'" 
                                            onFocus="if(this.value=='School')this.value='' " runat="server" 
                                            Enabled="False"/>
                                        <asp:TextBox ID="TextBox12" required value="Year Of Passing" 
                                ...
                                <p>
                                    <asp:TextBox ID="TextBox9" required value="City" 
                                        onBlur="if(this.value=='')this.value='City'" 
                                        onFocus="if(this.value=='City')this.value='' " runat="server" Enabled="False"/>
                                    <asp:TextBox ID="TextBox10" required value="State" 
                                        onBlur="if(this.value=='')this.value='State'" 
                                        onFocus="if(this.value=='State')this.value='' " runat="server" Enabled="False"></asp:TextBox></p>
                                    
                                  <p>
                                            <asp:TextBox ID="TextBox13" required value="Address" 
                                                onBlur="if(this.value=='')this.value='Address'" 
                                                onFocus="if(this.value=='Address')this.value='' " runat="server" 
                                                Enabled="False"/>
                                            <asp:TextBox ID="TextBox14" required value="Email ID" 
                                           ...
                                           <p>
                                               <asp:TextBox ID="TextBox15" required value="Mobile No." 
                                                   onBlur="if(this.value=='')this.value='Mobile No.'" 
                                                   onFocus="if(this.value=='Mobile No.')this.value='' " runat="server" 
                                                   Enabled="False"/>
                                               <asp:TextBox ID="TextBox16" required value="Parents Mobile No." 
                                                   onBlur="if(this.value=='')this.value='Parents Mobile No.'" 
                                                   onFocus="if(this.value=='Parents Mobile No.')this.value='' " runat="server" 
                                                   Enabled="False"></asp:TextBox></p>
                                               
                                               <p>
                                                   <asp:Button ID="Button1" value="Print"  Text="Print" runat="server" 
                                                    OnClientClick = "return PrintPanel();"   onclick="Button1_Click" 
                                                       Visible="False" />
                                                    
                                                   <asp:Button ID="Button2" value="submit"  Text="Submit" runat="server" 
                                                       onclick="Button2_Click"></asp:Button></p>
                    </ContentTemplate>
                     </asp:UpdatePanel>                          
				</asp:panel>
			</fieldset>
