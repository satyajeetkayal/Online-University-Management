		...
		<div id="fh5co-header">
			<div class="top">
				<div class="container">
					...
					<span> <a href="tel://+91345678910"><i class="icon-mobile3"></i> 123 4567 8910</a></span>
				</div>
			</div>
			<!-- end:top -->
				...
				<div class="container">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li>
								<a href="service.aspx" class="fh5co-sub-ddown">Services</a>
								 
							</li>
							<li><a href="about.aspx">About</a></li>
							<li><a href="blog.aspx">Blog</a></li>
							<li><a href="contact.aspx">֍ Contact</a></li>
								<li><a href="meetus.aspx">Dev. Team</a>
							</li>
						</ul>
					</nav>
					</div>
...
<div class="container">
  ...
  <form action="/action_page.php">
     ...
     <p> 
         <asp:TextBox ID="TextBox3" required value="First Name" onBlur="if(this.value=='')this.value='First Name'" onFocus="if(this.value=='First Name')this.value='' " runat="server"></asp:TextBox></p>
...
​
       ...
       <p>
           <asp:TextBox ID="TextBox2" required value="Last Name" onBlur="if(this.value=='')this.value='Last Name'" onFocus="if(this.value=='Last Name')this.value='' " runat="server"></asp:TextBox></p>
...
​
  ...
  <p><asp:DropDownList ID="DropDownList1" CssClass="select" runat="server">
...
​
    <p>
        <asp:TextBox ID="TextBox1" CssClass="textarea" required value="Write Something!" onBlur="if(this.value=='')this.value='Write Something!'" onFocus="if(this.value=='Write Something!')this.value='' " height:50px runat="server"></asp:TextBox></p>
...
​
   ...
   <p>
       <asp:Button ID="Button1" CssClass="abc" Text="Submit" runat="server"></asp:Button></p>
  </form>
