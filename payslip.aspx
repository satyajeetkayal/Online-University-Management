				...
				<div class="container">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="payslip.aspx">֍ PaySlip</a></li>
						</ul>
					</nav>
					</div>
				</div>
			...
			<fieldset>
				...
				<p>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                        ErrorMessage="Application No.(Numbers Only)" ControlToValidate="TextBox1" 
 ...
 <asp:Panel id="pnlContents" runat = "server">
    ...
    <ContentTemplate>
                    ...
                    <asp:TextBox ID="TextBox2"  required value="Student Name" 
                        ...
                        Enabled="False"/>
                    <asp:TextBox ID="TextBox7" required value="Session" 
                    ...
                    <asp:TextBox ID="TextBox3"  required value="Father Name" 
                            ...
                            Enabled="False"/>
                        <asp:TextBox ID="TextBox5" required value="Mother Name" 
                            onBlur="if(this.value=='')this.value='Mother Name'" 
                            onFocus="if(this.value=='Mother Name')this.value='' " runat="server" 
                            ontextchanged="TextBox5_TextChanged" Enabled="False"></asp:TextBox></p>
                    <p>
                        <asp:TextBox ID="TextBox4" required value="Branch" 
                            onBlur="if(this.value=='')this.value='Branch'" 
                            onFocus="if(this.value=='Branch')this.value='' " runat="server" 
                            Enabled="False"/>
                        </p>
                   
                    <p>
                        <asp:TextBox ID="TextBox6" required value="Amount" 
                            onBlur="if(this.value=='')this.value='Amount'" 
                            onFocus="if(this.value=='Amount')this.value='' " runat="server" 
                            CausesValidation="True"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="Required Amount" ControlToValidate="TextBox6">*</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                            ErrorMessage="Amount (Numbers Only)" ControlToValidate="TextBox6" 
                            ValidationExpression="\d+">**</asp:RegularExpressionValidator>
                        </p>
                  <p>
                    <asp:Button ID="btnPrint" runat="server" Text="Print" 
                      ...
                      <asp:Button ID="Button1" value="submit"  Text="Submit" runat="server" 
