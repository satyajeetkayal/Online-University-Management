...
<p>
	...
	<div id="login">
		...
		<h1><strong>Welcome Admin.</strong>login Here!</h1>
		     ...
		     <p>
                 <asp:TextBox ID="TextBox3" runat="server" onBlur="if(this.value=='')this.value='Unique ID'" 
                         onFocus="if(this.value=='Unique ID')this.value='' " required="" 
                     value="Unique ID" ontextchanged="TextBox3_TextChanged" AutoPostBack="True" 
                     CausesValidation="True"></asp:TextBox> 
		     
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                     ErrorMessage="ID (Only Numbers)" ControlToValidate="TextBox3" 
                     ValidationExpression="\d+">*</asp:RegularExpressionValidator></p>
		     ...
		     <p>
                 ...
                 <p>
                     <asp:TextBox ID="TextBox2" runat="server" 
                         onBlur="if(this.value=='')this.value='Admin ID'" 
                         onFocus="if(this.value=='Admin ID')this.value='' " required="" 
                         value="Admin ID" CausesValidation="True"></asp:TextBox>
                      
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                         ErrorMessage="Admin ID (Only Numbers)" ControlToValidate="TextBox2" 
                 ...
                 <p>
                     <asp:TextBox ID="TextBox1" runat="server" 
                         ...
                         value="Password" TextMode="Password"></asp:TextBox>
                 </p>
                 <!-- JS because of IE support; better: placeholder="Password" -->
                 <p>
                     <asp:Button ID="Button1" onclick="Button1_Click1" Text="Login" 
                         value="Login"  runat="server"/>
                         <asp:Button ID="Button2" value="register" Text="Register" runat="server" 
                         PostBackUrl="~/Adminregi.aspx" CausesValidation="False"></asp:Button></p>
