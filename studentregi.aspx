<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentregi.aspx.cs" Inherits="studentregi" %>
			...
			<header id="fh5co-header-section">
				<div class="container">
					<div class="nav-header">
						...
						<h1 id="fh5co-logo"><a href="homepage.aspx">UNIVERSITY OF UNIVERSITY</a></h1>
						<!-- START #fh5co-menu-wrap -->
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							
							</li>
							<li><a href="studentregi.aspx">֎ REGISTER</a></li>
		        ...
		        <fieldset>
                    ...
                    <p>
                        <asp:TextBox ID="TextBox1" runat="server" 
                            ...
                            value="First Name" CausesValidation="True"></asp:TextBox>
                    
                    
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ControlToValidate="TextBox1" ErrorMessage="Required First Name">*</asp:RequiredFieldValidator>
                    
                    
                        <asp:TextBox ID="TextBox2" runat="server" 
                            onBlur="if(this.value=='')this.value='Last Name'" 
                            onFocus="if(this.value=='Last Name')this.value=''" required="" 
                            value="Last Name" CausesValidation="True"></asp:TextBox>
                            
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                            ControlToValidate="TextBox2" ErrorMessage="Required Last Name">*</asp:RequiredFieldValidator>
                    </p>
                    ...
                    <p>
                        <asp:TextBox ID="TextBox3" runat="server" 
                            ...
                            value="UserName" CausesValidation="True" ></asp:TextBox>
                   
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                            ControlToValidate="TextBox3" ErrorMessage="Username  Formate (a-z|A-Z &amp; 0-9) Length 4-15" 
                            ValidationExpression="[a-zA-Z0-9]{4,15}$">*</asp:RegularExpressionValidator>
                   
                        <asp:TextBox ID="TextBox4" runat="server" 
                            onBlur="if(this.value=='')this.value='Password'" 
                            onFocus="if(this.value=='Password')this.value=''" required="" 
                            value="Password" CausesValidation="True"></asp:TextBox>
                            
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                            ControlToValidate="TextBox4" ErrorMessage="Password length 6-10  And a-z &amp;0-9" 
                            ValidationExpression="[a-zA-Z0-9]{6,10}$">*</asp:RegularExpressionValidator>
                    </p>
                    <p>
                        <asp:TextBox ID="TextBox5" runat="server" 
                            onBlur="if(this.value=='')this.value='Date Of Birth'" 
                            onFocus="if(this.value=='Date Of Birth')this.value=''" 
                            ontextchanged="TextBox5_TextChanged" required="" value="Date Of Birth" 
                            CausesValidation="True"></asp:TextBox>
                    
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
                            ControlToValidate="TextBox5" ErrorMessage="dd-mm-yyyy" 
                        ...
                        <asp:TextBox ID="TextBox6" runat="server" 
                            ...
                            value="Mobile No" CausesValidation="True"></asp:TextBox>
                            
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                            ControlToValidate="TextBox6" ErrorMessage="Only 10 Digits" 
                    ...
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="DropDownList1" ErrorMessage="Required Field">*</asp:RequiredFieldValidator>
                        <asp:TextBox ID="TextBox7" onBlur="if(this.value=='')this.value='Answer'" 
                            onFocus="if(this.value=='Answer')this.value=''" required="" 
                            value="Answer" runat="server" CausesValidation="True"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                            ControlToValidate="TextBox7" ErrorMessage="Required Field">*</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                            ErrorMessage="Answer In Charecters Only (a-z &amp;A-Z)" 
                            ValidationExpression="[a-zA-Z]{4,30}$" ControlToValidate="TextBox7">**</asp:RegularExpressionValidator>
                    </p>
                    ...
                    <p>
                        <a href="studentlogin.aspx" class="style1">Already have an account</a></p>
		...
		<footer>
			<div id="footer">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<p>Copyright 2017 <a href="#">ж Xenko engine</a>. All Rights Reserved. <br>Made with by <a href="meetus.aspx">sys Developer</a> / Demo Images: <a href="https://unsplash.com/">Unsplash</a></p>
						</div>
						<div class="col-md-6">
							<ul class="footer-menu">
								...
								<li><a href="meetus.aspx">Dev. Team</a></li>
							</ul>
						</div>
					</div>
				</div>
