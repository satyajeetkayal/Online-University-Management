				...
				<div class="container">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="studentlogin.aspx">֎ Login</a></li>
						</ul>
					</nav>
					</div>
				</div>
...
<body>
	...
	<div id="login">
		...
		<fieldset>
            ...
            <p>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ErrorMessage="UserName Formate a-z &amp; 0-9" ControlToValidate="TextBox2" 
                    ValidationExpression="[a-zA-Z0-9]{4,50}$">*</asp:RegularExpressionValidator>
            </p>
            ...
            <p>
                <asp:TextBox ID="TextBox1" runat="server" 
                    ...
                    value="Password" CausesValidation="True" TextMode="Password"></asp:TextBox>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                    ErrorMessage="Password Length 6-10 And a-z &amp; 0-9" 
                    ControlToValidate="TextBox1" ValidationExpression="[a-zA-Z0-9]{6,10}$">*</asp:RegularExpressionValidator>
            </p>
            <!-- JS because of IE support; better: placeholder="Password" -->
            <p>
                <a href="forget.aspx" class="style1">Forgot Password?</a></p>
            <p>
		...
		<p>
            ...
            <asp:Button ID="Button2" button class="facebook" Text="Register Here!" 
                runat="server" PostBackUrl="~/studentregi.aspx" CausesValidation="False"></asp:button>
