				...
				<div class="container">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							<li class="active">
								<a href="studentmenu.aspx">֎ Menu</a>
							</li>
						...
						<div class="row">
							...
							<h1>Admission Form</h1>
								<div class="fh5co-grid animate-box" style="background-image: url(images/work-2.jpg);">
									<a class="image-popup text-center" href="admissionfill.aspx">
										<div class="prod-title">
											<h3>֎ Admission Form Fill</h3>
											<span>Welcome! </span>
										</div>
									</a>
								</div>
							...
							<h1>Student Details</h1>
								<div class="fh5co-grid animate-box" style="background-image: url(images/work-3.jpg);">
									<a class="image-popup text-center" href="studentdetails.aspx">
										<div class="prod-title">
							...
							<h1>logout</h1>
								<div class="fh5co-grid animate-box" style="background-image: url(images/work-5.jpg);">
									<a class="image-popup text-center" href="studentlogin.aspx">
										<div class="prod-title">
											<h3>֎ LogOut</h3>
