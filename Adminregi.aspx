<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adminregi.aspx.cs" Inherits="Adminregi" %>
				...
				<div class="container">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="Adminregi.aspx">֎ REGISTER</a></li>
		...
		<ContentTemplate>
		        ...
		        <fieldset>
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
                        ShowMessageBox="True" />
                <p>
                    <asp:TextBox ID="TextBox1" required value="AdminID" 
                        onBlur="if(this.value=='')this.value='AdminID'" 
                        onFocus="if(this.value=='AdminID')this.value='' " runat="server" 
                        Enabled="False"></asp:TextBox></p>
                    
                    <p>
                        <asp:TextBox ID="TextBox2" required value="Password" 
                            onBlur="if(this.value=='')this.value='Password'" 
                            onFocus="if(this.value=='Password')this.value='' " runat="server" 
                            CausesValidation="True"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                            ErrorMessage="Password Length 6-10 Only" ControlToValidate="TextBox2" 
                            ValidationExpression="[a-zA-Z0-9]{6,10}$">*</asp:RegularExpressionValidator>
                        </p>
                        <p><a href="adminlogin.aspx">Already have an account</a></p>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<ul class="footer-menu">
								...
								<li><a href="homepage.aspx">Go Back!</a></li>
